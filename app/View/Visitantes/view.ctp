<div class="visitantes view">
<h2><?php echo __('Visitante'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($visitante['Visitante']['id']); ?>
			&nbsp;
		</dd>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Visitante'), array('action' => 'edit', $visitante['Visitante']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Visitante'), array('action' => 'delete', $visitante['Visitante']['id']), array(), __('Are you sure you want to delete # %s?', $visitante['Visitante']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($visitante['Partido'])): ?>
	...
	<?php foreach ($visitante['Partido'] as $partido): ?>
		<tr>
