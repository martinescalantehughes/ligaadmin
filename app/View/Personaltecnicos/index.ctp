<div class="personaltecnicos index">
	<div class="page-header">
	<h2><?php echo __('Personal Técnico'); ?></h2>
	</div>
							<div class="container">
							<?php echo $this->Form->create('Personaltecnico', array('class' => 'navbar-form navbar-left'));?>
	...
	<table cellpadding="0" cellspacing="0" class="table table-striped">
		...
		<tbody>
			<?php foreach ($personaltecnicos as $personaltecnico): ?>

				

			<tr>
				<td><?php echo $this->Html->image('/files/persona/foto/' . $personaltecnico['Persona']['foto_dir'] .'/' .'thumb_' . $personaltecnico['Persona']['foto'], array('class'=>'img-circle'))?></td>
				<td><?php echo h($personaltecnico['Persona']['nombre']); ?>&nbsp;</td>
				<td><?php echo h($personaltecnico['Persona']['apellido']); ?>&nbsp;</td>				
				...
				<div class="btn-group">
											  ...
											  <ul class="dropdown-menu">
												<li><?php echo $this->Html->link(__('Ver'), array('action' => 'view', $personaltecnico['Personaltecnico']['id'])); ?></li>
												<li><?php echo $this->Html->link(__('Editar'), array('action' => 'edit', $personaltecnico['Personaltecnico']['id'])); ?></li>
												<li><?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $personaltecnico['Personaltecnico']['id']),array('confirm' => __('Estás seguro de eliminar el personal técnico: '.$personaltecnico['Persona']['nombre'].'?'))); ?></li>
...
<div class="col-md-3">
	<div class="list-group">
		...
		<?php echo $this->Html->link(__('Registrar nuevo personal técnico'), array('action' => 'add'), array('class'=>'list-group-item')); ?> 	
	</div>
</div>
