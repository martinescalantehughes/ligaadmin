...
<?php echo $this->Form->create('Personaltecnico', array('type' => 'file',  'novalidate' => 'novalidate')); ?>
	<fieldset>
		<legend><?php echo __('Editar Datos del Personal Técnico'); ?></legend>
...
<div class="col-md-2">
	<div class="list-group">
		...
		<?php echo $this->Html->link(__('Volver a datos del Personal técnico'), array('controller' => 'personaltecnicos', 'action' => 'view',$this->Form->value('Personaltecnicos.id')), array('class'=>'list-group-item')); ?> 
