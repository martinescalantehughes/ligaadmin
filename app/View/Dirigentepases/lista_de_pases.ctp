<div class="dirigentepases index">
	...
	<div class="list-group">
	  ...
	  <?php echo $this->Html->link(__('Histórico de Dirigentes del Club'), array('controller' => 'dirigentepases', 'action' => 'historicopases', $club['Club']['id']), array('class'=>'list-group-item')); ?>
