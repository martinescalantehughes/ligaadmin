...
<div class="panel panel-default">
	...
	<div class="panel-body">
			<div class="dirigentepases form">
								...
								<fieldset>
								<?php echo $this->Form->input('Dirigentepase.club_id',array('label'=>'Club' ,'class'=>'form-control', 'style'=>'width:200px;'));?>
...
<div class="col-md-3">
	<div class="list-group">
	  ...
	  <?php echo $this->Html->link(__('Lista de dirigentes'), array('controller' => 'dirigenteclubs', 'action' => 'index'), array('class'=>'list-group-item')); ?>
		<?php echo $this->Html->link(__('Volver a datos del Dirigente'), array('controller' => 'dirigenteclubs', 'action' => 'view', $id), array('class'=>'list-group-item')); ?> 
