...
<?php echo $this->Form->create('Personalliga', array('type' => 'file',  'novalidate' => 'novalidate')); ?>
	<fieldset>
		<legend><?php echo __('Editar datos del Personal'); ?></legend>
...
<div class="col-md-2">
	<div class="list-group">
	  ...
	  <?php echo $this->Html->link(__('Lista de personal de la liga'), array('controller' => 'personalligas', 'action' => 'index'), array('class'=>'list-group-item')); ?>
		...
		<?php echo $this->Html->link(__('Volver a datos del Personal'), array('controller' => 'personalligas', 'action' => 'view',$this->Form->value('Personalliga.id')), array('class'=>'list-group-item')); ?> 
