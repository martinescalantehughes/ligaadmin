...
<div class="panel panel-default">
	...
	<div class="panel-body">
			<div class="pases form">
								...
								<fieldset>
								<?php echo $this->Form->input('Pase.club_id',array('label'=>'Club' ,'class'=>'form-control', 'style'=>'width:200px;'));?>
...
<div class="col-md-3">
	<div class="list-group">
	  ...
	  <?php echo $this->Html->link(__('Lista de jugadores'), array('controller' => 'jugadores', 'action' => 'index'), array('class'=>'list-group-item')); ?>
		<?php echo $this->Html->link(__('Volver a datos del jugador'), array('controller' => 'jugadores', 'action' => 'view', $id), array('class'=>'list-group-item')); ?> 
