...
<?php echo $this->Form->create('Jugadore', array('type' => 'file',  'novalidate' => 'novalidate')); ?>
	<fieldset>
		<legend><?php echo __('Editar datos del Jugador'); ?></legend>
...
<div class="col-md-2">
	<div class="list-group">
		...
		<?php echo $this->Html->link(__('Volver a datos del Jugador'), array('controller' => 'jugadores', 'action' => 'view',$this->Form->value('Jugadore.id')), array('class'=>'list-group-item')); ?> 
