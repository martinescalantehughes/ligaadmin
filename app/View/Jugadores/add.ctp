...
<?php echo $this->Form->create('Jugadore', array('type' => 'file',  'novalidate' => 'novalidate')); ?>
	<fieldset>
		<legend><?php echo __('Primer Registro del Jugador'); ?></legend>
                        ...
                        <div class="tab-pane fade in active" id="tab1default">
							...
							<div class="col-md-6">
								...
								<?php
									...
									echo $this->Form->input('Persona.paise_id', array('label'=>'País','options'=>$paisesp,'empty'=>'--Select--','class'=>'form-control'));     ?>       
