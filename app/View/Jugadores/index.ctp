<div class="jugadores index">
	...
	<h2><?php echo __('Jugadores'); ?></h2>
							...
							<div class="container">
							<?php echo $this->Form->create('Jugadore', array('class' => 'navbar-form navbar-left'));?>
	...
	<table cellpadding="0" cellspacing="0" class="table table-striped">
		...
		<tbody>
			...
			<tr>
				<td><?php echo $this->Html->image('/files/persona/foto/' . $jugadore['Persona']['foto_dir'] .'/' .'thumb_' . $jugadore['Persona']['foto'], array('class'=>'img-circle'))?></td>
				<td><?php echo h($jugadore['Persona']['nombre']); ?>&nbsp;</td>
				<td><?php echo h($jugadore['Persona']['apellido']); ?>&nbsp;</td>
				...
				<div class="btn-group">
											  ...
											  <ul class="dropdown-menu">
												<li><?php echo $this->Html->link(__('Ver'), array('action' => 'view', $jugadore['Jugadore']['id'])); ?></li>
												<li><?php echo $this->Html->link(__('Editar'), array('action' => 'edit', $jugadore['Jugadore']['id'])); ?></li>
												<li><?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $jugadore['Jugadore']['id']),array('confirm' => __('Estás seguro de eliminar el jugador: '.$jugadore['Persona']['nombre'].'?'))); ?></li>
...
<div class="col-md-3">
	<div class="list-group">
		...
		<?php echo $this->Html->link(__('Registrar nuevo jugador'), array('action' => 'add'), array('class'=>'list-group-item')); ?> 	
	</div>
</div>
