<div class="tecnicopases index">
	...
	<table cellpadding="0" cellspacing="0" class="table table-striped">
		<thead>
			<tr>
				<th><?php echo $this->Paginator->sort('Persona.apellido',"Nombre"); ?></th>
				<th><?php echo $this->Paginator->sort('Persona.dni',"DNI"); ?></th>
				<th><?php echo $this->Paginator->sort('Tecnicopase.fechadesde',"Fecha desde"); ?></th>
				<th><?php echo $this->Paginator->sort('Tecnicopase.fechahasta',"Fecha hasta"); ?></th>
				<th><?php echo $this->Paginator->sort('Tecnicopase.cargo',"Cargo"); ?></th>
	...
	<div class="list-group">
	  ...
	  <?php echo $this->Html->link(__('Personal técnico del Club'), array('controller' => 'tecnicopases', 'action' => 'lista_de_pases', $club['Club']['id']), array('class'=>'list-group-item')); ?>
