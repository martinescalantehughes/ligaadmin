...
<div class="panel panel-default">
	...
	<div class="panel-body">
			<div class="tecnicopases form">
								...
								echo $this->Form->input('Tecnicopase.club_id',array('label'=>'Club' ,'class'=>'form-control', 'style'=>'width:200px;'));?>
...
<div class="col-md-3">
	<div class="list-group">
	  ...
	  <?php echo $this->Html->link(__('Lista de personal técnico'), array('controller' => 'personaltecnicos', 'action' => 'index'), array('class'=>'list-group-item')); ?>
		<?php echo $this->Html->link(__('Volver a datos del Personal Técnico'), array('controller' => 'personaltecnicos', 'action' => 'view', $tecnicopase['Tecnicopase']['personaltecnico_id']), array('class'=>'list-group-item')); ?> 
