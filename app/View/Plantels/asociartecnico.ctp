...
<div class="panel panel-default">
     <div class="panel-heading">
            <h4>  <span class="
glyphicon glyphicon-edit" aria-hidden="true"></span><?php echo __(' Asociar Técnico'); ?>
			...
			<div class="fechas form">
								...
								<fieldset>
									...
									<?php 
										...
										echo $this->Form->input('Personaltecnico',array('label'=>'Seleccionar Personal técnico: ','id' => "Personaltecnico"));
					 				?>
									<script>
										var js = jQuery.noConflict();
										js("#Personaltecnico").select2({
											placeholder: "Ingrese nombre, apellido o DNI del Personal tecnico",
											width:'400px',
...
<div class="col-md-3">
	<div class="panel panel-info" >
		...
		<div class="panel-body" >
			<p><?php echo ('IMPORTANTE: Dentro del cuadro de selección usted puede asociar un personal técnico o varios tecnicos al plantel agregando elementos al mismo y guardando los cambios. Así como también, quitando los técnicos del cuadro de selección provocará la destrucción de la relación entre el/los tenico/s y el plantel.')?></p>
		</div>			
