<div class="row">
<div class="col-md-10">
<?php echo $this->Form->create('Dirigenteclub', array('type' => 'file',  'novalidate' => 'novalidate')); ?>
	<fieldset>
		<legend><?php echo __('Primer Registro del Dirigente'); ?></legend>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="tab2default">
                        	<div class="col-md-6">
							    ...
							    <div class="input-group">
								    <?php echo $this->Form->input('Dirigenteclub.fechaafiliacion', array(
								    	'dateFormat' => 'DMY',
									    'minYear' => date('Y') - 5,
									    'maxYear' => 1900,
								        'class' => 'form-control',
							    ...
							    <div class="input-group">
								    <?php echo $this->Form->input('Dirigenteclub.fecharenovacion', array(
								    	'dateFormat' => 'DMY',
									    'minYear' => date('Y') + 2,
									    'maxYear' => date('Y'),
							...
							<div class="col-md-6">
								...
								<?php
									...
									echo $this->Form->hidden('Dirigenteclub.persona_id');

									echo $this->Form->input('Dirigenteclub.ligachaquenia_id',array('label'=>'Liga' ,'class'=>'form-control'))
								?>                        	
							</div>
                        </div> <!-- fin tab2 -->
