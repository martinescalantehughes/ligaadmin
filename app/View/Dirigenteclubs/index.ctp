<div class="dirigenteclubs index">
	<div class="page-header">
	<h2><?php echo __('Dirigentes de Clubes'); ?></h2>
	</div>
							<div class="container">
							<?php echo $this->Form->create('Dirigenteclub', array('class' => 'navbar-form navbar-left'));?>
	...
	<table cellpadding="0" cellspacing="0" class="table table-striped">
		...
		<tbody>
			<?php foreach ($dirigenteclubs as $dirigenteclub): ?>

				

			<tr>
				<td><?php echo $this->Html->image('/files/persona/foto/' . $dirigenteclub['Persona']['foto_dir'] .'/' .'thumb_' . $dirigenteclub['Persona']['foto'], array('class'=>'img-circle'))?></td>
				<td><?php echo h($dirigenteclub['Persona']['nombre']); ?>&nbsp;</td>
				<td><?php echo h($dirigenteclub['Persona']['apellido']); ?>&nbsp;</td>
				
				<td><?php echo h($dirigenteclub['Persona']['dni']); ?>&nbsp;</td>
				<td><?php echo h($dirigenteclub['Persona']['fechanac']); ?>&nbsp;</td>
				...
				<div class="btn-group">
											  ...
											  <ul class="dropdown-menu">
												<li><?php echo $this->Html->link(__('Ver'), array('action' => 'view', $dirigenteclub['Dirigenteclub']['id'])); ?></li>
												<li><?php echo $this->Html->link(__('Editar'), array('action' => 'edit', $dirigenteclub['Dirigenteclub']['id'])); ?></li>
												<li><?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $dirigenteclub['Dirigenteclub']['id']),array('confirm' => __('Estás seguro de eliminar al dirigene: '.$dirigenteclub['Persona']['nombre'].'?'))); ?></li>
...
<div class="col-md-3">
	<div class="list-group">
		...
		<?php echo $this->Html->link(__('Registrar nuevo Dirigente'), array('action' => 'add'), array('class'=>'list-group-item')); ?> 	
	</div>
</div>
